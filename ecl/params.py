...
DEFAULTS = {
    ...
    "centres": {
        # All in radii; the px values were measured at r=279 (half-res plane).
        # These bound the ONE global radius acquisition, on the least eclipsed
        # frame. They were the last three raw pixel counts in the pipeline, and
        # they are why a disc smaller than 180 px could not be found at all.
        "r_search_min_r": 0.645,
        "r_search_max_r": 1.219,
        "r_bootstrap_min_r": 0.215,
    },
    "track": {
...
_COMMENTS = {
    ...
    "centres.r_search_min_r": "smallest solar radius the acquisition searches, in radii of the surveyed disc",
    "centres.r_search_max_r": "largest solar radius the acquisition searches, likewise",
    "centres.r_bootstrap_min_r": "floor under the first bounding-box radius guess",
